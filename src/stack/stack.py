...
class stack:
    ...
    def __init__(self):
        ...
        self.__tail = self.__head   #reference to the botton node in the stack
    ...
    def getData(self):
        ...
        """        
        cursor = self.__head    #used to step through the nodes in the ceiling stack
    ...
    def pop(self):
        ...
        try:
            ...
            #Get daya in node at the head (top) of the calling stack
